 ...
 */
public class ResponseSubscriber implements Subscriber<ByteBuffer>, Disposable {
...
private final static Logger logger = LoggerFactory.getLogger(ResponseSubscriber.class);
