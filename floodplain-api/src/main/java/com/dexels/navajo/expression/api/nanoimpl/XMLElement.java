 ...
 *****************************************************************************/
package com.dexels.navajo.expression.api.nanoimpl;
 ...
 * {@link #getStringAttribute(String) getStringAttribute}. The
...
public class XMLElement implements Serializable {
	 ...
	 * </dl>
	 *
	 * @see nanoxml.XMLElement#XMLElement(Hashtable)
	 *      XMLElement(Hashtable)
	 * @see nanoxml.XMLElement#XMLElement(boolean)
	 * @see nanoxml.XMLElement#XMLElement(Hashtable,boolean)
...
//		Enumeration<String> en = this.entities.keys();
	 ...
	 * <dl>
	 *
	 * @see nanoxml.XMLElement#setDoubleAttribute(String, double)
	 *      setDoubleAttribute(String, double)
	 * @see nanoxml.XMLElement#setIntAttribute(String, int)
	 *      setIntAttribute(String, int)
	 * @see nanoxml.XMLElement#enumerateAttributeNames()
	 * @see nanoxml.XMLElement#getAttribute(String)
	 *      getAttribute(String)
	 * @see nanoxml.XMLElement#getAttribute(String, Object)
	 *      getAttribute(String, Object)
	 * @see nanoxml.XMLElement#getAttribute(String,
	 *      Hashtable, String, boolean) getAttribute(String,
	 *      Hashtable, String, boolean)
	 * @see nanoxml.XMLElement#getStringAttribute(String)
	 ...
	 * @see nanoxml.XMLElement#setDoubleAttribute(String, double)
	 *      setDoubleAttribute(String, double)
	 * @see nanoxml.XMLElement#setAttribute(String, Object)
	 *      setAttribute(String, Object)
	 * @see nanoxml.XMLElement#removeAttribute(String)
	 *      removeAttribute(String)
	 * @see nanoxml.XMLElement#enumerateAttributeNames()
	 * @see nanoxml.XMLElement#getIntAttribute(String)
	 *      getIntAttribute(String)
	 * @see nanoxml.XMLElement#getIntAttribute(String, int)
	 ...
	 *      removeAttribute(String)
	 * @see nanoxml.XMLElement#enumerateAttributeNames()
	 * @see nanoxml.XMLElement#getDoubleAttribute(String)
	 *      getDoubleAttribute(String)
	 * @see nanoxml.XMLElement#getDoubleAttribute(String, double)
	 ...
	 *      Hashtable, String, boolean)
	 *      getDoubleAttribute(String, Hashtable, String, boolean)
	 * @see nanoxml.XMLElement#getBooleanAttribute(String,
	 ...
	 *
	 * @see nanoxml.XMLElement#setContent(String) setContent(String)
	 */
	 ...
	 *
	 * @see nanoxml.XMLElement#setName(String) setName(String)
	 */
	 ...
	 *
	 * @see nanoxml.XMLElement#write(Writer) write(Writer)
	 */
	@Override
	...
	public Vector<XMLElement> getElementsByTagName(String tag) {
