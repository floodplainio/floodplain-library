...
object FloodplainDeps {
    const val floodplain_version = "0.9.25-SNAPSHOT"
    ...
    const val debezium_version = "1.2.0.Final"
    const val testContainer_version = "1.14.3"
    const val kotlin_version = "1.3.7"
    ...
    const val kotlinCoroutines  = "org.jetbrains.kotlinx:kotlinx-coroutines-core:$kotlin_version"
