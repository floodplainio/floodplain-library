...
public class CompiledParser/*@bgen(jjtree)*/implements CompiledParserTreeConstants, CompiledParserConstants {/*@bgen(jjtree)*/
  ...
  final public ASTPipeDefinition PipeDefinition() throws ParseException {
 /*@bgen(jjtree) PipeDefinition */
  ASTPipeDefinition jjtn000 = new ASTPipeDefinition(JJTPIPEDEFINITION);
 ...
 Token t; boolean isParam = false;
    ...
    jjtc001 = false;
    jjtn001.jjtSetLastToken(getToken(0));
   jjtn001.val = t.image; jjtn001.isParam = isParam;
    } catch (Throwable jjte001) {
                             if (jjtc001) {
                               jjtree.clearNodeScope(jjtn001);
                               jjtc001 = false;
  ...
  private boolean jj_3_8() {
    if (jj_scan_token(PIPESTART)) return true;
    if (jj_3R_15()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
