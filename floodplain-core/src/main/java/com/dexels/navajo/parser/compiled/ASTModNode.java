...
final class ASTModNode extends SimpleNode {
	...
	public ContextExpression interpretToLambda(List<String> problems, String expression, Function<String, FunctionClassification> functionClassifier, Function<String,Optional<Node>> mapResolver) {
		return lazyBiFunction(problems,expression, (a,b)->interpret(a, b),emptyOrType(ImmutableMessage.ValueType.INTEGER),(a,b)->Optional.of(ImmutableMessage.ValueType.INTEGER),functionClassifier,mapResolver);
	}
