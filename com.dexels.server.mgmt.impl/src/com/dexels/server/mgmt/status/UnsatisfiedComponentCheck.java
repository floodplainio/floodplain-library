...
@Component(name="dexels.osgi.unsatisfiedcomponentcheck",configurationPolicy=ConfigurationPolicy.REQUIRE)
public class UnsatisfiedComponentCheck implements ServerHealthCheck {
	...
	private synchronized void update() {
		...
		this.currentIssues.addAll(unsatisfiedReference());
	}

	public List<String> unsatisfiedReference() {
		final ArrayList<String> list = OSGiStatus.listComponents(_bundleContext,serviceComponentRuntime,e->{ 
