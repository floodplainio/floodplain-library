 ...
 *****************************************************************************/
package io.floodplain.streams.xml.parser;
...
public class XMLElement implements java.io.Serializable {
     ...
     * </ul>
     *
     * @param skipLeadingWhitespace <code>true</code> if leading and trailing whitespace in
...
//		Enumeration<String> en = this.entities.keys();
    ...
    public void parseFromStream(InputStream in) throws IOException, UnsupportedEncodingException {
        ...
        if (read != 3) {
            if (read == -1) {
                throw new IOException("Can't parse XML: Perhaps empty stream?");
            }
            throw new IOException("No comprendo!!!:" + read);
        }
