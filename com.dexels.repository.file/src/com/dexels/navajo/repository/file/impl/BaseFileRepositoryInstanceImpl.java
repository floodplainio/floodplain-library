...
public abstract class BaseFileRepositoryInstanceImpl extends RepositoryInstanceImpl implements RepositoryInstance {
	...
	private final static Logger logger = LoggerFactory
			.getLogger(BaseFileRepositoryInstanceImpl.class);
	...
	protected void setupMonitoredFolders(List<String> monitored) throws IOException {
		...
		try {
			...
			logger.error("Ignoring error, file notifications may not work properly");
		}
	}
	...
	protected File findConfiguration(String path, String fileInstallPath)
		...
		logger.info("FileRepository for path: {}",path);
