...
public class UnsignJarTask  {
	...
	public static void downloadDepencency(Dependency d, File repoDir, File destinationFolder, String securityHeader, List<String> extraHeaders) throws IOException {
		...
		File ff = d.getFilePathForDependency(repoDir, securityHeader);
