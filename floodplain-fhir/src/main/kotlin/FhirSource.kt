...
fun <T : IBaseResource> fhirExistingSource(topic: String, transform: (T)-> IMessage, rootTopology: Stream, init: Source.() -> Unit = {}): Source {
    ...
    val sourceElement = CustomTopicSource(
        Topic.fromQualified(topic,rootTopology.topologyContext),
